...
export type PortfolioAnalyzerNode = Node<{ name: string, description: string, status: string }, 'portfolio-analyzer-node'>;
...
export type AppNode = BuiltInNode | AgentNode | InvestmentReportNode | JsonOutputNode | PortfolioAnalyzerNode | PortfolioManagerNode | StockAnalyzerNode;
